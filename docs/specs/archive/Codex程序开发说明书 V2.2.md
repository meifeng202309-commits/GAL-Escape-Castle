...
> **V2.2 specification-repair revision:** resolves Coding Manager implementation blockers and ambiguity. V2.1/V2.0 are no longer current source-of-truth files.

> Updated against `古堡逃脱游戏脚本 V3.3.md` and the latest pushed Sprint 1 completion/validation state.
>
...
3. `Codex程序开发说明书 V2.2.md`（本文件）

Repository hygiene：
- V3.3 / V2.2 是当前source-of-truth；
...
Codex **不得因为 V3.3 剧情升级而重写 Sprint 1**。
...
- `# 29. FUTURE MODULE`
- `# 30. V3.3 MAIN-GAME TERMINATION RULE`
...
- `# 42. V3.3 Production Detail Rule`
- `# 44. 场景分类：图片 / UI / 音效`
...
# 8.1 V3.3 content corrections that Codex must preserve
...
# 9. ACT 12：必须按 V3.3 的 ENGAGE gate 实现
...
V2.2不要求在 Sprint 2 重做 authentication。
...
# 21. Definition of Done — Codex Guide V2.2

V2.2 生效意味着：

- script source更新为 V3.3；
