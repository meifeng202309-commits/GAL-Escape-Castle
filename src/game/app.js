...
async function refreshState() {
  ...
  try {
    ...
    if (discussionState.active) {
      ...
      if(session!==activeSession)return;
      if(sprint6State.active)renderSprint6(sprint6State);else if(sprint5State.active)renderSprint5(sprint5State,pocketState);else renderSprint3b(sprint3bState);
      return;
    }
