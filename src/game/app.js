...
async function markSprint6AudioConsumed(occurrenceId,outcome="ended"){if(!occurrenceId)return;await rpc("s6_mark_audio_consumed",{p_room_code:activeSession.room_code,p_session_token:activeSession.session_token,p_occurrence_id:occurrenceId,p_outcome:outcome}).catch(error=>console.warn("Sprint6 audio consumption was not recorded",occurrenceId,error))}
