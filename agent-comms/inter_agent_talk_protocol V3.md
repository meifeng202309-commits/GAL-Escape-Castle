...
This file preserves the five-role protocol introduced in V2 and adds the User-directed bounded VA auxiliary fragmented/temporary support responsibility. It supersedes V2.
