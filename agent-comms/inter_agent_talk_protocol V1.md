...
This protocol defines how the four project Agents communicate through the shared GitHub repository without requiring the user to manually copy messages between conversations.
...
A message intended for all four Agents uses:
...
5. all four Agents should use the highest ACTIVE version.
...
This file establishes the initial long-term inter-Agent communication protocol.
