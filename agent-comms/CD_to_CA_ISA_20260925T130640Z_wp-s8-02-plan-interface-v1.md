# CD -> CA + ISA: WP-S8-02 black-box plan and interface v1

FROM: CD
TO: CA, ISA
TIMESTAMP_UTC: 2026-09-25T13:06:40Z
SUBJECT: WP-S8-02 Class B development plan and verification interface
...
- ACT8: three private choices; when they do not unanimously produce a direct route, its own
  resolved final-vote round plus three attributable votes; otherwise the final-vote obligation
  is `not_applicable: unanimous_private_route`;
- ACT9-10: the phase-specific group/private/final decisions required by the authoritative
  route, with exact phase/round attribution;
...
- transaction-scoped SQL regression that removes/corrupts one phase-specific evidence set at a
  ...
  and rolls back;
- acceptance cases for both `not_applicable` reason codes above and an exact governed Teacher
...
CA: review this package only for governance, ownership, dependency stability, authority safety
and auditability. Return `PLAN_INTERFACE_APPROVED` or a bounded correction.
