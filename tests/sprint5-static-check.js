...
const creationRestore = fs.readFileSync("database/032_sprint5_discussion_creation_restore.sql", "utf8");
...
if (!app.includes('item.current_view==="back"?"act01-l.017":"act01-l.002"') || !app.includes("localizedHtml(watchEvidenceKey)")) throw new Error("Stopped Watch visible evidence does not follow authoritative front/back view.");
