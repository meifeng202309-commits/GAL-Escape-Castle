...
do $$
declare v_run uuid;v_act2_override uuid;v_act5_override uuid;v_discussion uuid;v_count integer;v_route text;
begin
...
select 'PASS Level2 override route and absence-validity integrity' as result;
