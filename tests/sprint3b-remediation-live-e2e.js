...
async function fixture() {
  ...
  await rpc("s2_start_run", { p_room_code: room, p_teacher_token: teacher, p_run_mode: "audit" });
...
async function main() {
  ...
  const teacher = await teacherState(canonical);
  ...
  pass("teacher event ledger exposes explicit context");
