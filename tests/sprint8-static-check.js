...
const act6EffectiveRound=fs.readFileSync('database/053_sprint8_act6_effective_round_integrity.sql','utf8');
...
for(const token of ["resolution='portrait_fixed_fallback'",'effective_round:=2','distinct_choices=3',"resolution_source='player_majority'","'{obligations,act6.effective_vote}'"])assert(act6EffectiveRound.includes(token),`053 correction missing ${token}`);
